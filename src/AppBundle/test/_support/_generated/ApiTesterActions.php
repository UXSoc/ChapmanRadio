<?php  //[STAMP] bd7a574b867818f09d02ec7d9fe6645b
...
use AppBundle\Helper\Fixtures;
use AppBundle\Helper\FactoryHelper;
...
trait ApiTesterActions
{
     ...
     * @see \AppBundle\Helper\Fixtures::loadFixture()
     */
    public function loadFixture($fixture) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('loadFixture', func_get_args()));
    }
     ...
     * @see \AppBundle\Helper\FactoryHelper::factory()
     */
