...
function notify($msg, $color="#090") { return "<div class='gloss' style='border:1px solid $color;color:$color;text-align:center;'>$msg</div>"; }
function append($msg) { return "<br /><small style='color:#757575'>$msg</small>"; }
