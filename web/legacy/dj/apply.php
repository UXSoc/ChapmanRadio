...
function RenderPictureTab(){
	global $show;
	Template::AddBodyContent(menu("picture"));
	Template::AddBodyContent("
...
function RenderAvailabilityTab(){
	...
	Template::AddBodyContent(menu("availability"));
	Template::AddBodyContent("
...
function RenderFinalizeTab(){
	global $show;
	Template::AddBodyContent(menu("finalize"));
	
	$requirements = calcRequirements($show);
	if($requirements) {
		Template::AddBodyContent("
		...
		foreach($requirements as $dat) {
			...
			if($cat != $prevCat) {
				switch($cat) {
					case "djs": $catName = "DJs"; break;
					case "showinfo": $catName = "Show Info"; break;
					default: $catName = ucfirst($cat);
				}
