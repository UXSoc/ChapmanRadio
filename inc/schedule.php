...
class Schedule
{
    ...
    public static function HappenedAt($timestamp)
    {
        return Schedule::GetShowAt($timestamp, 'all');
    }

    public static function HappeningNow()
    {
        return Schedule::GetShowAt(time(), 'all');
    }

    public static function HappeningSoon($count)
    {
        return Schedule::NextShows(time(), 'all', $count);
    }

    public static function HappeningFrom($start, $end)
    {
        return Schedule::ShowsFrom($start, $end, 'all');
    }

    /* 2. What is scheduled with Staff alterations (could show a show that didn't show up) */
    public static function ShouldHappenAt($timestamp)
    {
        return Schedule::GetShowAt($timestamp, 'staff');
    }

    public static function ShouldHappenNow()
    {
        return Schedule::GetShowAt(time(), 'staff');
    }

    public static function ShouldHappenSoon($count)
    {
        return Schedule::NextShows(time(), 'staff', $count);
    }

    public static function ShouldHappenFrom($start, $end)
    {
        return Schedule::ShowsFrom($start, $end, 'staff');
    }

    /* 3. What is usually happening with No alterations */
    public static function ScheduledAt($timestamp)
    {
        return Schedule::GetShowAt($timestamp, 'none');
    }

    public static function ScheduledNow()
    {
        return Schedule::GetShowAt(time(), 'none');
    }

    public static function ScheduledSoon($count)
    {
        return Schedule::NextShows(time(), 'none', $count);
    }

    public static function ScheduledFrom($start, $end)
    {
        return Schedule::ShowsFrom($start, $end, 'none');
    }
