...
class Version20170421154216 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE attendance RENAME TO attendance_temp;');
...
;');
    ...
    ;');
        ...
        $this->addSql('DROP TABLE `attendance_temp`');

        $this->addSql('DROP VIEW chapman_radio.v_training_slots RESTRICT;');
        $this->addSql('DROP VIEW chapman_radio.v_training_signups RESTRICT;');
        $this->addSql('DROP VIEW chapman_radio.v_news_active RESTRICT;');
        $this->addSql('DROP VIEW chapman_radio.v_livechat RESTRICT;');
        $this->addSql('DROP VIEW chapman_radio.v_listener_map RESTRICT;');
        $this->addSql('DROP VIEW chapman_radio.v_features_active RESTRICT;');
