 ...
 */
class Version20170518205203 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user (id BIGINT AUTO_INCREMENT NOT NULL, facebook_id BIGINT DEFAULT NULL, email VARCHAR(100) NOT NULL, student_id VARCHAR(15) NOT NULL, phone VARCHAR(30) NOT NULL, name VARCHAR(120) NOT NULL, last_login DATETIME NOT NULL, password VARCHAR(200) NOT NULL, suspended TINYINT(1) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, username VARCHAR(30) DEFAULT NULL, confirmed TINYINT(1) DEFAULT NULL, confirmation_token VARCHAR(30) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE show_dj (id BIGINT AUTO_INCREMENT NOT NULL, show_id BIGINT DEFAULT NULL, dj_id BIGINT DEFAULT NULL, INDEX show_dj_show_id_fk (show_id), INDEX show_dj_id_fk (dj_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
